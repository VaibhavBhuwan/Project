...
String x = (String)application.getAttribute("id");
  ...
  Class.forName("com.mysql.jdbc.Driver");
	 ...
	 %><b>ticket_no_________bus_id________route_id________date____________time______________credit_card_no_________seat_no__________name__________age__________sex__________personal_id___________destination________source__________phone</b><%
		
	 while(result.next())
	 {
		t_no=result.getInt("ticket_no");
		u_id= result.getString("user_id");
		b_id=result.getInt("bus_id");
